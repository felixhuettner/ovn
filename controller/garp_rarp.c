                      ...
                      bool update_only)
{
    ...
    if (strcmp(b->mac, mac_string)) {
         ...
         * in SB DB. */
        if (sbrec_server_has_mac_binding_table_col_timestamp(ovsdb_idl_txn_get_idl(ovnsb_idl_txn))) {
...
static void
garp_rarp_clear(struct garp_rarp_ctx_out *r_ctx_out)
{
...
void
garp_rarp_run(const struct garp_rarp_ctx_in *r_ctx_in,
              struct garp_rarp_ctx_out *r_ctx_out)
{
    garp_rarp_clear(r_ctx_out);
